...
// เรียกฟังก์ชัน expressFunction() ซึ่งผลลัพธ์จะได้กลับมาเป็นออบเจ็กต์ แล้วนำไปเก็บยังตัวแปร express
...
expressApp.get('/api/resource', function(req, res) {
    Students.findOne({ id: "B6220709" }, (err, data) => {
        res.send(data);
    });
});

// สร้าง Event Listener รอการเชื่อมต่อจากพอร์ต 3000
